function build_desktop_panel()
{
    ...
    var legend_data = [[{name: "Good Area", color: ""}, {name: null, color: "purple"}],
		       [{name: "Possible", color: ""}, {name: null, color: "orange"}],
		       [{name: "Unlikely", color: ""}, {name: null, color: "green"}],
		      ]
...
function build_mobile_panel()
{
    ...
    var legend_data = [[{name: "Good Area", color: ""}, {name: null, color: "purple"}, {name: "Possible Area", color: ""}, {name: null, color: "orange"}, {name: "Unlikely Area", color: ""}, {name: null, color: "green"}],
		      ]
